...
const PrevIconButton = (props) => {
  ...
  return (<button onClick={props.onClick} type="button" className={`bg-white ${colors.lightHoverTextShadowColor} ${colors.lightHoverShadowColor} shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] text-black font-bold py-2 px-4 rounded-full disabled:opacity-60`}>
