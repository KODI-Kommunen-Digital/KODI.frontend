...
const NextIconButton = (props) => {
  return (<button onClick={props.onClick} type="button" className="bg-white hover:text-orange-500  text-black font-bold py-2 px-4 rounded-full disabled:opacity-60">
