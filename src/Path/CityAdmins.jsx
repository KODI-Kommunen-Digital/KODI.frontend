    ...
    useEffect(() => {
        if (searchTerm === "") {
            ...
            const filtered = admins.filter(admin =>
                (admin.name || admin.username || "").toLowerCase().includes(searchTerm.toLowerCase())
            );
                ...
                <table className="w-full text-sm text-left text-gray-500">
                    <thead className="text-xs text-gray-700 uppercase bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" className="px-6 py-4 text-center">{t("username")}</th>
                            <th scope="col" className="px-6 py-4 text-center">{t("email")}</th>
                            <th scope="col" className="px-6 py-4 text-center text-right">{t("actions")}</th>
                        </tr>
                    </thead>
                    <tbody>
                ...
                <div className="bg-white mt-4 p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label className="block text-sm font-medium text-gray-700"> {t("cityName")}</label>
                                <input
                                    type="text"
                                    value={city.name || ""}
                                    readOnly
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700">  {t("parentCity")}</label>
                                <input
                                    type="text"
                                    value={city.parentCity?.name}
                                    readOnly
                                    className="mt-1 border p-3 bg-white text-gray-800 border-gray-700 shadow-md placeholder:text-base duration-300 border-gray-300 rounded-lg w-full"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <div>
                                    <div className="relative mb-4" ref={dropdownRef}>
                                        ...
                                        />
                                        {newAdmin.name && (
                                            <div className="absolute right-3 top-3 cursor-pointer text-red-600" onClick={() => {
                                        ...
                                        {isDropdownOpen && (
                                            <div className="absolute top-full mt-1 w-full bg-white rounded-lg shadow-lg z-10 max-h-40 overflow-y-auto border border-gray-700">
                                                {filteredUsers.length === 0 ? (
                                                    <div className="px-3 py-2 text-gray-500 italic">{t("noUserFound")}</div>
                                                ) : (
                                                    filteredUsers.map((user) => (
                                                        <div
                                                            ...
                                                            onClick={() => {
                                                                ...
                                                                setDropdownInput(user.name || user.username || "");
                                                                setIsDropdownOpen(false);
                                                            }}
