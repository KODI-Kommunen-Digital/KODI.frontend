...
const UserManagement = () => {
    ...
    const updateForumStatusById = useCallback(
        async (forumId, approvalStatus) => {
            try {
    ...
    const updateChannelStatusById = useCallback(
        async (channelId, approvalStatus) => {
            try {
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex">
                            {tabs.map((tab) => (
                                <button
                                    key={tab.id}
                                    className={`px-4 py-2 font-medium text-md text-bold transition-all duration-200 ${
                                        activeTab === tab.id
                        ...
                        {activeTab === "channels" && channels.length > 0 && (
                            <div className="flex justify-center mt-4 p-4 space-x-2">
                                ...
                                <span className="px-4 py-1 text-sm text-slate-50">
                                    {t("page")} {channelCurrentPage} {t("of")}{" "}
                                    {channelTotalPages}
                                </span>
                                ...
                                <button
                                    ...
                                    disabled={
                                        channelCurrentPage === channelTotalPages
                                    }
                                    className="px-3 py-1 bg-gray-200 rounded disabled:opacity-50 flex items-center"
                                >
                                    <svg
