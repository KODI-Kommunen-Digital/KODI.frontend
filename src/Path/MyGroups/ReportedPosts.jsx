...
import "../../index.css";
import { getReportedPosts, updatePost } from "../../Services/forumsApi";
...
const ReportedPosts = () => {
    ...
    useEffect(() => {
        ...
        getReportedPosts(cityIdParam, forumIdParam).then((response) => {
                                        ...
                                        >
                                            ...
                                            >
                                                <img
                                                    ...
                                                    src={
                                                        report.image
                                                            ? process.env.REACT_APP_BUCKET_HOST + report.image
                                                            : PROFILEPICTURE
                                                    }
                                                    alt="avatar"
                                                />
                                                <div className="pl-0 sm:pl-3 overflow-hidden max-w-[20rem] sm:max-w-[10rem]">
                                                    <div
                                                        ...
                                                        onClick={() =>
                                                            navigateTo(`/Forum/ViewPost?postId=${report.id}&forumId=${forumId}&cityId=${cityId}`)
                                                        }
                                                    >
                                                        {report.title}
                                                    </div>
