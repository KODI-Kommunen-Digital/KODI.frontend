...
import dummyCityListing from "../Constants/cityListingDummy";
const AllCities = () => {
    window.scrollTo(0, 0);
    ...
    console.log("dummy_CityListing", dummyCityListing)
    ...
    const fetchCities = useCallback(() => {
        ...
        const filteredDummyData = dummyCityListing.filter(city =>
            city.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
            city.parentCity.toLowerCase().includes(searchQuery.toLowerCase())
        );
        setCities(filteredDummyData);
                ...
                <div className="h-full">
                    ...
                    <div className="bg-white mt-4 p-0">
                        <h2
                            ...
                            style={{
                                fontFamily: "'Space Grotesk', Helvetica, Arial, Lucida, sans-serif",
                            }}
                        >
                            {t("cities")}
                        </h2>
                        <div className="overflow-x-auto">
                            {(paginatedCities.length > 0) && <table className="w-full text-sm text-left text-gray-500 p-6 space-y-10 rounded-lg">
                                            ...
                                            <tr key={index} className="bg-white border-b hover:bg-gray-50">
                                                ...
                                                <td className="px-6 py-4">
                                                    <div className="flex items-center justify-center">
                                                        <div
                                                            ...
                                                            onClick={() => navigateTo(`/categories?cityId=${city.id}`)}
                                                        >
                                                ...
                                                <td className="px-6 py-4">
                                                    <div className="flex items-center justify-center">
                                                        <div
                                                            className="relative group inline-block"
                                                            onClick={() => navigateTo(`/admins?cityId=${city.id}`)}
                                                        >
                                                            <FaEye className={`text-2xl ${RegionColors.darkTextColor} cursor-pointer`} />
                                                            <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 w-max bg-black text-white text-sm py-1 px-2 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                                                {t("viewDetails")}
