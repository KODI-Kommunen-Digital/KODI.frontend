...
import {
  getAllForums,
  getUserForumsMembershipForAllForums,
  createMemberRequest,
  cancelMemberRequest,
        ...
        try {
          ...
          if (forumIds) {
            const membershipResponse =
              await getUserForumsMembershipForAllForums(cityId, { forumIds });
            const membershipResponseData = membershipResponse.data.data;
            const membershipStatus = {};
            membershipResponseData.forEach((memberresponse) => {
              membershipStatus[memberresponse.forumId] =
                memberresponse.statusId;
    ...
    <section className="text-gray-600 bg-white body-font">
      ...
      <div>
        ...
        <div className="mt-5 mb-20 customproview py-6">
          ...
          <div className={`mt-20 mb-20 rounded-xl w-fit mx-auto text-center text-white whitespace-nowrap rounded-md border border-transparent ${process.env.REACT_APP_NAME === 'Salzkotten APP' ? 'bg-yellow-600 hover:bg-yellow-400' : process.env.REACT_APP_NAME === 'WUNSIEDEL' ? 'bg-lime-700 hover:bg-lime-300' : 'bg-blue-800 hover:bg-blue-400 shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)]'} px-8 py-2 text-base font-semibold cursor-pointer`}>
            {pageNo !== 1 ? (
              <span
