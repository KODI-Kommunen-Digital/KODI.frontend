			...
			<div class="mx-auto grid max-w-2xl grid-cols-1 gap-y-16 gap-x-8 pt-24 pb-8 px-4 sm:px-6 sm:pt-32 sm:pb-8 lg:max-w-7xl lg:grid-cols-3 lg:pb-4">
				<div className="grid grid-cols-1 gap-4 col-span-2">
					...
					<div class="overflow-hidden sm:p-0 mt-[5rem] px-0 py-0">
						<h1 class="text-lg font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white"  style={{ fontFamily: 'Poppins, sans-serif' }}>
							{t("aboutMe")}
						</h1>
						<p class="leading-relaxed text-md font-medium my-6 text-gray-900 dark:text-gray-900"  style={{ fontFamily: 'Poppins, sans-serif' }}>
							{user?.description}
						</p>
					</div>
				</div>
				...
				{userSocial && userSocial.length > 0  ? (
					<div class="w-full h-80 md:ml-[6rem] lg:ml-[0rem] ml-[1rem] bg-white rounded-lg dark:border md:mt-0 sm:max-w-md xl:p-0 dark:border-white shadow-xl dark:bg-white">
						<div class="p-4 space-y-0 md:space-y-6 sm:p-4">
							<h1 class="text-lg font-bold leading-tight tracking-tight text-gray-900 md:text-xl dark:text-gray-900"  style={{ fontFamily: 'Poppins, sans-serif' }}>
								{t("contactInfo")}
							</h1>
						</div>
						...
						<div class="flex-grow text-center sm:text-left mt-6 sm:mt-0 justify-center py-2 px-2 sm:justify-start mx-4 my-4 gap-4">
							<div class="flex items-center">
								...
								<p class="leading-relaxed text-base dark:text-gray-900 bg-white py-1 mt-1 mb-1"  style={{ fontFamily: 'Poppins, sans-serif' }}>
									{user?.email}
								</p>
							</div>
							{user?.website && (
