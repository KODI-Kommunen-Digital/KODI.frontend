  ...
  return (
    <section class="text-gray-600 bg-white body-font">
      ...
      <div class="mx-auto grid max-w-2xl grid-cols-1  gap-y-16 gap-x-8 py-24 px-4 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-3 lg:px-8">
        ...
        <div class="w-full justify-center md:ml-[6rem] lg:ml-[0rem] ml-[1rem] md:h-[20rem] sm:h-[20rem] bg-white rounded-lg dark:border md:mt-0 sm:max-w-md xl:p-0 dark:border-gray-700 shadow-xl dark:bg-white">
