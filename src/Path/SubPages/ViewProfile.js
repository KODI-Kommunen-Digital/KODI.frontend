        ...
        {userSocial && userSocial.length > 0 ? (
          ...
          <div className="w-full h-56 md:ml-[6rem] lg:ml-[0rem] ml-[1rem] bg-white rounded-lg dark:border md:mt-0 sm:max-w-md xl:p-0 dark:border-white shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] dark:bg-white">
            <div className="p-4 space-y-0 md:space-y-6 sm:p-4">
              <h1
                className="text-lg font-bold leading-tight tracking-tight text-slate-800 md:text-xl dark:text-slate-800"
                style={{ fontFamily: "Poppins, sans-serif" }}
              >
                {t("contactInfo")}
              </h1>
            ...
            <div className="flex-grow text-center sm:text-left mt-6 sm:mt-0 justify-center p-4 sm:p-4 sm:justify-start gap-4">
              <div className="flex items-center px-2">
                ...
                <p
                  className="leading-relaxed text-base dark:text-slate-800 bg-white py-1 mt-1 mb-1 truncate"
                  style={{ fontFamily: "Poppins, sans-serif" }}
                >
                  {user?.email}
                </p>
