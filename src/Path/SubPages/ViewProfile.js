			...
			<div class="mx-auto grid max-w-2xl grid-cols-1 gap-y-16 gap-x-8 pt-24 pb-8 px-4 sm:px-6 sm:pt-32 sm:pb-8 lg:max-w-7xl lg:grid-cols-3 lg:pb-4">
				<div className="grid grid-cols-1 gap-4 col-span-2">
								...
								<form action="#" method="POST">
									<div class="bg-white py-6 mt-4 mb-4 flex flex-wrap gap-10 justify-Start">
										...
										<div class="flex-grow text-center sm:text-left mt-6 sm:mt-0">
											<h2
												class="text-gray-900 text-lg title-font mb-2 font-bold dark:text-gray-900"
											...
											<p
												class="leading-relaxed text-base dark:text-gray-900"
												style={{ fontFamily: "Poppins, sans-serif" }}
											>
												{t("entries")}
											</p>
					...
					<div class="overflow-hidden sm:p-0 mt-[5rem] px-0 py-0">
						...
						<p
							class="leading-relaxed text-md font-medium my-6 text-gray-900 dark:text-gray-900"
							style={{ fontFamily: "Poppins, sans-serif" }}
						>
							{user?.description}
						</p>
				...
				{userSocial && userSocial.length > 0 ? (
					<div class="w-full h-80 md:ml-[6rem] lg:ml-[0rem] ml-[1rem] bg-white rounded-lg dark:border md:mt-0 sm:max-w-md xl:p-0 dark:border-white shadow-xl dark:bg-white">
						<div class="p-4 space-y-0 md:space-y-6 sm:p-4">
							<h1
								class="text-lg font-bold leading-tight tracking-tight text-gray-900 md:text-xl dark:text-gray-900"
								style={{ fontFamily: "Poppins, sans-serif" }}
							>
								{t("contactInfo")}
							</h1>
						...
						<div class="flex-grow text-center sm:text-left mt-6 sm:mt-0 justify-center py-2 px-2 sm:justify-start mx-4 my-4 gap-4">
							<div class="flex items-center">
								...
								<p
									class="leading-relaxed text-base dark:text-gray-900 bg-white py-1 mt-1 mb-1"
									style={{ fontFamily: "Poppins, sans-serif" }}
								>
									{user?.email}
								</p>
				...
				{listings && listings.length > 0 ? (
								...
								listings
									...
									.map((listing) => (
										...
										>
											...
											<div class="mt-5 px-2">
												<h2
													class="text-gray-900 title-font text-lg font-bold text-center font-sans truncate"
													style={{ fontFamily: "Poppins, sans-serif" }}
												>
													{listing.title}
												</h2>
											...
											{listing.id && listing.categoryId == 3 ? (
												<p
													class="text-gray-600 title-font text-sm font-semibold text-center font-sans"
													style={{ fontFamily: "Poppins, sans-serif" }}
												>
													{new Date(
												...
												<p
													class="text-gray-600 p-2 h-[1.8rem] title-font text-sm font-semibold text-center font-sans truncate"
													style={{ fontFamily: "Poppins, sans-serif" }}
					...
					<div>
						<div class="flex items-center justify-center">
							<h1
								class=" m-auto mt-20 text-center font-sans font-bold text-2xl text-black"
								style={{ fontFamily: "Poppins, sans-serif" }}
							>
						...
						<div
							class="m-auto mt-10 mb-40 text-center font-sans font-bold text-xl"
							style={{ fontFamily: "Poppins, sans-serif" }}
						>
