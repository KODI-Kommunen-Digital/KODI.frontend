				...
				<div>
					<div className="mx-auto w-full grid max-w-2xl grid-cols-1 gap-y-16 gap-x-8 pt-24 pb-8 px-4 sm:px-6 sm:pt-32 sm:pb-8 lg:max-w-7xl lg:grid-cols-3 lg:pt-24 lg:pb-4">
						<div className="grid grid-cols-1 gap-4 col-span-2">
							...
							{/* {input.pdf ? (
						<a
							href={process.env.REACT_APP_BUCKET_HOST + input.pdf}
							download
							className="rounded-xl bg-white border border-blue-400 text-blue-400 py-2 px-4 text-sm cursor-pointer mt-2 text-center justify-end"
							style={{
								fontFamily: "Poppins, sans-serif",
								textDecoration: "none",
							}}
