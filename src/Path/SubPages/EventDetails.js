...
const EventDetails = () => {
    ...
    useEffect(() => {
        ...
        if (listingId && cityId) {
            ...
            getListingsById(cityId, listingId, params).then(
                (listingsResponse) => {
                    setInput(listingsResponse.data.data);
                    const cityUserId = listingsResponse.data.data.userId;
                    getProfile(cityUserId, { cityId, cityUser: true }).then(
                        (res) => {
                            ...
                            <div className="mt-5 md:col-span-2 md:mt-0">
                                <form method="POST">
                                    <div className="flex flex-col sm:flex-row sm:items-center text-start justify-between">
                                        ...
                                        <div
                                            className={`flex items-center ${favClass}`}
                                        >
                                            <button
                                                type="button"
