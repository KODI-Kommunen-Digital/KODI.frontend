...
const HomePage = () => {
  ...
  return (
    <section class="text-gray-600 body-font relative">
      ...
      <h2
        class="font-sans font-bold text-gray-900 mb-20 text-3xl md:text-4xl mt-20 lg:text-5xl title-font text-center"
        style={{ fontFamily: "Poppins, sans-serif" }}
      >
      ...
      <div class="bg-white lg:px-10 md:px-5 sm:px-0 px-2 py-6 mt-10 mb-10 flex flex-col">
        <div class="grid xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-2 gap-4 relative mb-4 justify-center place-items-center">
          ...
          >
            ...
            <h2
              class="flex items-center justify-center m-auto mt-2 text-center font-sans font-bold"
              style={{ fontFamily: "Poppins, sans-serif" }}
            >
              {t("news")}
            </h2>
          ...
          >
            ...
            <h2
              class="flex items-center justify-center m-auto mt-2 font-sans font-bold text-center"
              style={{ fontFamily: "Poppins, sans-serif" }}
            >
              {t("roadTraffic")}
            </h2>
                ...
                >
                  <div class="relative h-80 rounded overflow-hidden">
                    ...
                    <div class="absolute inset-0 flex flex-col justify-end bg-gray-800 bg-opacity-50 text-white z--1">
                      <h1
                        class="text-xl pb-5 md:text-3xl font-sans font-bold mb-0 ml-4"
                        style={{ fontFamily: "Poppins, sans-serif" }}
                      >
                        {city.name}
                      </h1>
        ...
        <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 relative mb-4 justify-center gap-4 place-items-center">
          <div class="pb-10 w-full mb-4 bg-gray-100 rounded-lg cursor-pointer">
            <div class="relative h-96 rounded overflow-hidden w-auto">
              ...
              <div class="p-6">
                <h2
                  class="text-gray-900 mb-5 text-2xl md:text-2xl lg:text-3xl mt-5 title-font text-start font-bold font-sans"
                  style={{ fontFamily: "Poppins, sans-serif" }}
                >
                  {t("createAnAccount")}
                </h2>
                <p
                  class="text-gray-900 title-font text-lg font-bold text-start font-sans"
                  style={{ fontFamily: "Poppins, sans-serif" }}
                >
