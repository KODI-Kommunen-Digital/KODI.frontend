...
const HomePage = () => {
    ...
    return (
        <section className="text-gray-600 body-font relative">
            <HomePageNavBar />
            {showPopup && (
                <PrivacyPolicyPopup onClose={handlePrivacyPolicyAccept} />
            )}
                ...
                <div className="w-full mr-0 ml-0">
                    <div className="h-[35rem] overflow-hidden px-0 py-1">
                        <div className="relative h-[35rem]">
                            ...
                            <div className="absolute w-96 m-auto inset-0 flex mb-40 flex-col items-center justify-end bg-opacity-50 text-white z--1">
                                <div className="relative mb-4 flex sm:w-full w-80 flex-wrap items-stretch">
                                    <select
                                        id="city"
                                        name="city"
            ...
            <div className="bg-white lg:px-10 md:px-5 sm:px-0 px-2 py-6 mt-10 mb-10 flex flex-col">
                <div className="grid xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-2 gap-4 relative mb-4 justify-center place-items-center">
                    ...
                    >
                        ...
                        <h2
                            className="flex items-center justify-center m-auto mt-2 font-sans font-bold text-center"
                            style={{ fontFamily: "Poppins, sans-serif" }}
                        >
                            {t("roadTraffic")}
                        </h2>
