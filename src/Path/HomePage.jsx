...
const HomePage = () => {
  ...
  return (
    <section class="text-gray-600 body-font relative">
        ...
        <div class="w-full mr-0 ml-0">
          <div class="h-[35rem] overflow-hidden px-0 py-1">
            <div class="relative h-[35rem]">
              ...
              <h1 className="font-sans mb-40 text-4xl md:text-6xl lg:text-7xl text-center font-bold tracking-wide" style={{ fontFamily: 'Poppins, sans-serif' }}>
                  {t("homePageHeading")}
                </h1>
              </div>
              ...
              <div class="absolute w-96 m-auto inset-0 flex mb-40 flex-col items-center justify-end bg-opacity-50 text-white z--1">
                <div class="relative mb-4 flex sm:w-full w-80 flex-wrap items-stretch">
                  <select
                    ...
                    value={cityId || 0}
                    class="bg-gray-50 border font-sans border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-50 dark:border-gray-300 dark:placeholder-gray-400 dark:text-gray-900 dark:focus:ring-blue-500 dark:focus:border-blue-500"style={{ fontFamily: 'Poppins, sans-serif' }}
                  >
      ...
      <h2 class="font-sans font-bold text-gray-900 mb-20 text-3xl md:text-4xl mt-20 lg:text-5xl title-font text-center" style={{ fontFamily: 'Poppins, sans-serif' }}>
      ...
      <div class="bg-white lg:px-10 md:px-5 sm:px-0 px-2 py-6 mt-10 mb-10 flex flex-col">
        <div class="grid xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-2 gap-4 relative mb-4 justify-center place-items-center">
          ...
          >
            ...
            <h2 class="flex items-center justify-center m-auto mt-2 text-center font-sans font-bold" style={{ fontFamily: 'Poppins, sans-serif' }}>
              {t("news")}
            </h2>
          </div>
          <div
          ...
          >
            ...
            <h2 class="flex items-center justify-center m-auto mt-2 font-sans font-bold text-center" style={{ fontFamily: 'Poppins, sans-serif' }}>
              {t("roadTraffic")}
            </h2>
          </div>
          <div
      ...
      <h2 class="text-gray-900 mb-20 text-3xl md:text-4xl lg:text-5xl mt-20 title-font text-center font-sans font-bold" style={{ fontFamily: 'Poppins, sans-serif' }}>
                ...
                >
                  <div class="relative h-80 rounded overflow-hidden">
                    ...
                    <div class="absolute inset-0 flex flex-col justify-end bg-gray-800 bg-opacity-50 text-white z--1">
                      <h1 class="text-xl pb-5 md:text-3xl font-sans font-bold mb-0 ml-4" style={{ fontFamily: 'Poppins, sans-serif' }}>
                        {city.name}
                      </h1>
                    </div>
                  </div>
      ...
      {listings && listings.length > 0 ? (
        ...
        <div>
          ...
          <div class="m-auto mt-10 mb-40 text-center font-sans font-bold text-xl">
            ...
            <a
              class="m-auto mt-20 text-center font-sans font-bold text-xl cursor-pointer text-black" style={{ fontFamily: 'Poppins, sans-serif' }}
              onClick={() => {
        ...
        <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 relative mb-4 justify-center gap-4 place-items-center">
          <div class="pb-10 w-full mb-4 bg-gray-100 rounded-lg cursor-pointer">
            <div class="relative h-96 rounded overflow-hidden w-auto">
              ...
              />
              <div class="p-6">
                <h2 class="text-gray-900 mb-5 text-2xl md:text-2xl lg:text-3xl mt-5 title-font text-start font-bold font-sans"style={{ fontFamily: 'Poppins, sans-serif' }}>
                  {t("createAnAccount")}
                </h2>
                <p class="text-gray-900 title-font text-lg font-bold text-start font-sans"style={{ fontFamily: 'Poppins, sans-serif' }}>
      ...
      <div className="bg-blue-400 mx-auto py-10 px-4 flex justify-center lg:h-[28rem] sm:h-[35rem]">
        <div className="flex flex-wrap items-center">
          <div className="w-full md:w-1/2 px-4">
            <h2 className="text-4xl text-white font-bold mb-4 font-sans" style={{ fontFamily: 'Poppins, sans-serif' }}>
              {t("citizenService")}
            </h2>
            <p className="mb-4 text-gray-900 text-lg font-bold font-sans" style={{ fontFamily: 'Poppins, sans-serif' }}>
