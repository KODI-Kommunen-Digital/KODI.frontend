            ...
            <div className="bg-slate-600">
                ...
                {this.state.pageLoading ? (
                    ...
                    <div>
                                ...
                                <div className="relative mb-4">
                                    ...
                                    <div className="py-3 grid grid-cols-1">
                                        <div className="mt-1 px-2">
                                            ...
                                            <div className="py-2 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-8">
                                                ...
                                                <div className="flex flex-col justify-center items-start">
                                                    <button
                                                        ...
                                                        className="bg-black hover:bg-slate-600 text-white font-bold py-2 px-4 rounded content-center"
                                                        style={{
                                                            fontFamily:
                                                                "Poppins, sans-serif",
                                                        }}
                        ...
                        <SocialMedia
                            setSocialMedia={this.setSocialMedia.bind(this)}
                        />
