...
function UploadListings() {
    ...
    const [categories] = useState(categoryById);
    const [subCategories] = useState(subcategoryById);
    ...
    const [val] = useState([{ socialMedia: "", selected: "" }]);
                        ...
                        <div className="relative mb-4">
                            ...
                            >
                                ...
                                {villages.map((village) => (
                                    <option key={village.id} value={Number(village.id)}>
                                        {village.name}
                                    </option>
                                ))}
                            </select>
