    ...
    return (
        <div>
            {isFirstPopupOpen && (
            <div className={`fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50 z-20 ${isOpen ? '' : 'hidden'}`}>
                <div className="bg-white p-6 lg:rounded-md fixed top-0 overflow-y-auto max-h-[90vh]">
                    ...
                    <div className="p-0 mt-0 mb-0 grid grid-cols-1 sm:grid-cols-2 gap-4 justify-center sm:w-[50rem] md:w-[40rem] lg:w-[50rem]">
                        <div className="p-2">
                            ...
                            <p className='font-semibold my-4'>
                            {t("privacypolicyp2")}<a href="/PrivacyPolicy" class="text-blue-800 font-semibold">
                            {t("privacypolicyp5")}</a>{t("privacypolicyp6")}<a href="/PrivacyPolicy" class="text-blue-800 font-semibold">{t("privacypolicyp7")}</a>.
                            </p>
                        </div>
                        <div className="p-2">
                            <h3 className="text-lg font-semibold mt-4">{t("privacypolicyh1")}</h3>
                            <p className='font-semibold'>{t("privacypolicyp3")}</p>

                            <div className="flex items-center">
                                {/* <input type="checkbox" id="externalMediaCheckbox" className="mr-2" /> */}
                                <h3 className="text-lg font-semibold mt-4">{t("privacypolicyh2")}</h3>
                            </div>
            ...
            {isSecondPopupOpen && (
            <div className={`fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50 z-20 ${isSecondPopupOpen ? '' : 'hidden'}`}>
                <div className="bg-white p-6 lg:rounded-md fixed top-0 overflow-y-auto max-h-[90vh]">
                    <div className="flex justify-center gap-4 py-2 px-4 mt-4 mx-auto">
                        <div className="text-center">
                            <img
                    ...
                    <div className="p-0 mt-0 mb-0 grid grid-cols-1 sm:grid-cols-1 gap-4 justify-center sm:w-[50rem] md:w-[40rem] lg:w-[50rem]">
                        <div className="p-2 font-semibold">
                            <p className='font-semibold my-4'>
                            {t("privacypolicyp8")} <a href="/PrivacyPolicy" class="text-blue-800 font-semibold">
                            {t("privacypolicyp9")}</a>{t("privacypolicyp10")}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="p-0 mt-0 mb-0 grid grid-cols-1 sm:grid-cols-2 gap-4 justify-center sm:w-[50rem] md:w-[40rem] lg:w-[50rem]">
                        <div className="bg-gray-200 items-center mt-4 p-2 rounded-md">
                            <h3 className="text-lg font-semibold mb-2">{t("privacypolicyh3")}</h3>
                            <p className='font-semibold'>{t("privacypolicyp11")}</p>
                        </div>

                        <div className="bg-gray-200 items-center mt-4 p-2 rounded-md">
                            <h3 className="text-lg font-semibold mb-0">{t("privacypolicyh4")}</h3>
                            <p className='font-semibold'>
                            {t("privacypolicyp12")}
                            </p>
                        </div>
