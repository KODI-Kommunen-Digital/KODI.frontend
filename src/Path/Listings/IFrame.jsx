...
const IFrame = ({ cityId }) => {
    ...
    return (
        <section className="text-gray-600 body-font relative custom-scroll">
            <div className="mt-2 mb-2 customproview py-2">
                ...
                {isLoading ? (
                    ...
                    <div>
                        {listings && listings.length > 0 ? (
                            <div className="bg-white lg:px-10 md:px-5 sm:px-0 px-0 py-0 mt-0 mb-00 space-y-10 flex flex-col">
                                <div className="relative place-items-center bg-white mt-0 mb-4 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-4 gap-10 justify-start">
                                    {listings &&
