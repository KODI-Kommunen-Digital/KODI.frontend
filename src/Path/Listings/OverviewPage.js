    ...
    return (
        <section class="bg-slate-600 body-font relative h-screen">
            ...
            <div class="bg-white mt-4 p-6 space-y-10">
                    ...
                    <div class="grid xl:grid-cols-4 lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-2 grid-cols-2 gap-4 relative mb-4 justify-center place-items-center">
                        <div onClick={() => {
                                localStorage.setItem("selectedItem", "News");
                                goToListingsPage(1);
                            }}
                            class="p-4 justify-center bg-white sm:h-40 h-44 sm:w-48 w-32 shadow-xl rounded-lg mt-10 cursor-pointer">
