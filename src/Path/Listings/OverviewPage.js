        ...
        <div class="bg-white mt-4 p-6 space-y-10">
                ...
                <div class="bg-white p-5 mt-4 mb-4 flex flex-wrap gap-20 justify-center">
                    <div onClick={() => {
                        ...
                        navigateTo("/ListingsPage");
                        }}
                        class="p-4 justify-center bg-white h-40 w-48 shadow-2xl rounded-lg mt-10 cursor-pointer">
                        ...
                        <h2 class = "flex items-center justify-center m-auto mt-2 font-semibold text-center">{t("news")}</h2>
                    </div>
                    <div onClick={() => {
                        localStorage.setItem("selectedItem", "roadTraffic");
                        navigateTo("/ListingsPage");
                        }} class="p-4 justify-center bg-white h-40 w-48 shadow-2xl rounded-lg mt-10 cursor-pointer">
                        ...
                        <h2 class = "flex items-center justify-center m-auto mt-2 font-semibold text-center">{t("roadTraffic")}</h2>
                    </div>
                    <div onClick={() => {
                        ...
                        <h2 class = "flex items-center justify-center m-auto mt-2 font-semibold text-center">{t("events")}</h2>
                    </div>
                    <div onClick={() => {
                        ...
                        <h2 class = "flex items-center justify-center m-auto mt-2 font-semibold text-center">{t("clubs")}</h2>
                    </div>
                    <div onClick={() => {
                        localStorage.setItem("selectedItem", "regionalProducts");
                        navigateTo("/ListingsPage");
                        }} class="p-4 justify-center bg-white h-40 w-48 shadow-2xl rounded-lg mt-10 cursor-pointer">
                        ...
                        <h2 class = "flex items-center justify-center m-auto mt-2 font-semibold text-center">{t("regionalProducts")}</h2>
                    </div>
                    <div onClick={() => {
                        localStorage.setItem("selectedItem", "offerSearch");
                        navigateTo("/ListingsPage");
                        }} class="p-4 justify-center bg-white h-40 w-48 shadow-2xl rounded-lg mt-10 cursor-pointer">
                        ...
                        <h2 class = "flex items-center justify-center m-auto mt-2 font-semibold text-center">{t("offerSearch")}</h2>
                    </div>
                    <div onClick={() => {
                        localStorage.setItem("selectedItem", "newCitizenInfo");
                        navigateTo("/ListingsPage");
                        }} class="p-4 justify-center bg-white h-40 w-48 shadow-2xl rounded-lg mt-10 cursor-pointer">
                        ...
                        <h2 class = "flex items-center justify-center m-auto mt-2 font-semibold text-center">{t("newCitizenInfo")}</h2>
                    </div>
                    <div onClick={() => {
                        localStorage.setItem("selectedItem", "defectReport");
                        navigateTo("/ListingsPage");
                        }} class="p-4 justify-center bg-white h-40 w-48 shadow-2xl rounded-lg mt-10 cursor-pointer">
                        ...
                        <h2 class = "flex items-center justify-center m-auto mt-2 font-semibold text-center">{t("defectReport")}</h2>
                    </div>

                    <div onClick={() => {
                        localStorage.setItem("selectedItem", "lostAndFound");
                        navigateTo("/ListingsPage");
                        }} class="p-4 justify-center bg-white h-40 w-48 shadow-2xl rounded-lg mt-10 cursor-pointer">
                        ...
                        <h2 class = "flex items-center justify-center m-auto mt-2 font-semibold text-center">{t("lostAndFound")}</h2>
                    </div>
                    <div onClick={() => {
                        localStorage.setItem("selectedItem", "carpoolingPublicTransport");
                        navigateTo("/ListingsPage");
                        }} class="p-4 justify-center bg-white h-40 w-48 shadow-2xl rounded-lg mt-10 cursor-pointer">
                        ...
                        <h2 class = "flex items-center justify-center m-auto mt-2 font-semibold text-center">{t("companyPortaits")}</h2>
                    </div>
                    <div class="p-4 justify-center bg-white h-40 w-48 shadow-2xl rounded-lg mt-10 cursor-pointer">
                        ...
                        <h2 class = "flex items-center justify-center m-auto mt-2 font-semibold text-center">{t("carpoolingPublicTransport")}</h2>
                    </div>
                    <div onClick={() => {
                        ...
                        <h2 class = "flex items-center justify-center m-auto mt-2 font-semibold text-center">{t("offers")}</h2>
                    </div>
                </div>
            </div>
        </div>
