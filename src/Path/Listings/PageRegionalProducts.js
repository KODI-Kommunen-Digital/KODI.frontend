...
import { getListingsById, postListingsData, updateListingsData } from "../../Services/listingsApi";
...
function ListingsPageRegionalProducts() {
  ...
  useEffect(() => {
    document.title = "Regional Products";
  }, []);
...
export default ListingsPageRegionalProducts;
