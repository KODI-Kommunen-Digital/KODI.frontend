    ...
    return (
        <footer className="text-center md:text-left bg-black text-white">
            <div className="mx-6 py-10 text-center md:text-left">
                <div
                    className={`grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-10 md:gap-20 lg:px-20 md:px-5 px-5 py-6 justify-center md:justify-start`}
                >
                    ...
                    <div className="">
                        ...
                        <p className="mb-4">
                            <a
                                href="https://www.rottenburg.de/impressum+rottenburgapp.149766.htm?Inav=149765"
                                className="text-gray-600 font-sans"
                            >
                                {t("imprint")}
                            </a>
                        ...
                        <p className="mb-4">
                            <a
                                href="https://www.rottenburg.de/datenschutzerklaerung+rottenburgapp.149797.htm?Inav=149765"
                                className="text-gray-600 font-sans"
                            >
                                {t("data_protection")}
                            </a>
