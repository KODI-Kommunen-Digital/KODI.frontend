...
const LocationBar = () => {
    ...
    return (
        <div className={`${RegionColors.darkBgColor} px-4 md:px-10 lg:px-[20rem] py-4 flex justify-center`}>
            <div className="bg-white rounded-full flex items-center shadow-md px-4 py-2 w-full">
                ...
                <div className="flex items-center flex-1">
                    <span className="text-gray-700 mr-2">{t("allCategories")}</span>
                    <svg
                ...
                {/* Distance Dropdown */}
                <div className="relative flex items-center flex-1" ref={dropdownRef}>
                    <button
