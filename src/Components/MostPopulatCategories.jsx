...
const MostPopulatCategories = ({ listingsCount, t, goToAllListingsPage }) => {
    ...
    return (
        <div className="lg:px-10 md:px-5 sm:px-0 px-2 py-6 mt-0 mb-0 flex flex-col w-full">
                        ...
                        {visibleCategories.map((listing) => {
                            ...
                            switch (listing.categoryId) {
                                case 1:
                                    // categoryName = t("news");
                                    categoryIcon = (
                                        <div className="h-20 w-20 bg-cyan-400 flex items-center justify-center rounded-full m-auto shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                                            <svg
                                ...
                                case 3:
                                    ...
                                    categoryIcon = (
                                        <div className="h-20 w-20 bg-yellow-400 flex items-center justify-center rounded-full m-auto shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 448 512"
                                                className="h-8 w-8"
                                ...
                                case 4:
                                    ...
                                    categoryIcon = (
                                        <div className="h-20 w-20 bg-green-400 flex items-center justify-center rounded-full m-auto shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 448 512"
                                                className="h-8 w-40 mr-2"
                                ...
                                case 5:
                                    ...
                                    categoryIcon = (
                                        <div className="h-20 w-20 bg-violet-400 flex items-center justify-center rounded-full m-auto shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 448 512"
                                                className="h-8 w-40 mr-2"
                                ...
                                case 6:
                                    ...
                                    categoryIcon = (
                                        <div className="h-20 w-20 bg-fuchsia-400 flex items-center justify-center rounded-full m-auto shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 448 512"
                                                className="h-8 w-8"
                                ...
                                case 7:
                                    ...
                                    categoryIcon = (
                                        <div className="h-20 w-20 bg-stone-400 flex items-center justify-center rounded-full m-auto shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 448 512"
                                ...
                                case 9:
                                    ...
                                    categoryIcon = (
                                        <div className="h-20 w-20 bg-gray-500 flex items-center justify-center rounded-full m-auto shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 448 512"
                                                className="h-8 w-40 mr-2"
                                ...
                                case 10:
                                    ...
                                    categoryIcon = (
                                        <div className="h-20 w-20 bg-pink-400 flex items-center justify-center rounded-full m-auto shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 448 512"
                                ...
                                case 11:
                                    ...
                                    categoryIcon = (
                                        <div className="h-20 w-20 bg-lime-600 flex items-center justify-center rounded-full m-auto shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 448 512"
                                                className="h-8 w-40 mr-1"
                                ...
                                case 12:
                                    ...
                                    categoryIcon = (
                                        <div className="h-20 w-20 bg-sky-600 flex items-center justify-center rounded-full m-auto shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 448 512"
                                                className="h-8 w-40 mr-1"
                                ...
                                case 13:
                                    ...
                                    categoryIcon = (
                                        <div className="h-20 w-20 bg-red-400 flex items-center justify-center rounded-full m-auto shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 448 512"
                                                className="h-8 w-8"
                                ...
                                case 14:
                                    ...
                                    categoryIcon = (
                                        <div className="h-20 w-20 bg-orange-400 flex items-center justify-center rounded-full m-auto shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 448 512"
                                                className="h-8 w-40 mr-1"
                                ...
                                case 15:
                                    ...
                                    categoryIcon = (
                                        <div className="h-20 w-20 bg-teal-400 flex items-center justify-center rounded-full m-auto shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 448 512"
                                                className="h-8 w-40 mr-2"
                                ...
                                case 16:
                                    ...
                                    categoryIcon = (
                                        <div className="h-20 w-20 bg-rose-400 flex items-center justify-center rounded-full m-auto shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 448 512"
                                                className="h-8 w-8"
                                ...
                                case 17:
                                    ...
                                    categoryIcon = (
                                        <div className="h-20 w-20 bg-purple-400 flex items-center justify-center rounded-full m-auto shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 448 512"
                                                className="h-8 w-40 mr-1"
