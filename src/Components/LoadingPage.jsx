  ...
  return (
    <div className={location.pathname === '/' ? "relative h-full flex items-center justify-center bg-white" : "fixed inset-0 flex items-center justify-center bg-white"}>
      ...
      <div className="text-center">
        <h1 className={`text-2xl md:text-4xl lg:text-6xl text-center font-bold py-20 font-sans bg-clip-text ${colors.darkTextColor}`}>
          {t("loading")}
        </h1>
        <div className="my-10 flex">
          <div className={`relative mx-auto h-24 w-24 rounded-full border-t-8 border-b-8  ${colors.lightBorderColor} animate-spin`}></div>
