...
function SideBar() {
  ...
  const toggleStoremenu = (path) => {
    storeMenuVisible = true; 
    if (path) {
      navigate(path);
    }
  ...
  return (
    ...
    <div>
      <div
        className="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-slate-600 text-white"
        onClick={() =>toggleStoremenu('/storedetail')}
      >
        <svg
          ...
          viewBox="0 0 24 24"
        >
          <path d="M21 7h-1V5c0-1.1-.9-2-2-2H6c-1.1 0-2 .9-2 2v2H3c-.6 0-1 .4-1 1v2c0 .5.4 1 1 1h.1l1.7 6.7c.2.6.7 1.1 1.4 1.1H18c.7 0 1.2-.4 1.4-1.1L21.9 11H22c.5 0 1-.5 1-1V8c0-.6-.5-1-1-1zM6 5h12v2H6V5zm12.3 13H5.7l-1.5-6h15.6l-1.5 6zM12 12v6c0 .5-.4 1-1 1s-1-.5-1-1v-6c0-.5.4-1 1-1s1 .5 1 1zm5 0v6c0 .5-.4 1-1 1s-1-.5-1-1v-6c0-.5.4-1 1-1s1 .5 1 1zm-10 0v6c0 .5-.4 1-1 1s-1-.5-1-1v-6c0-.5.4-1 1-1s1 .5 1 1z" />
        </svg>
        <span
          className="text-[15px] ml-4 text-gray-200 font-bold"
          style={{ fontFamily: 'Poppins, sans-serif' }}
      ...
      {storeMenuVisible && (
        <div className="ml-10 mt-2">
          <div
            className="p-1 mt-1 flex items-center rounded-md px-6 duration-300 cursor-pointer hover:bg-slate-600 text-white"
            onClick={() => {
              toggleStoremenu('/storedetail');
          ...
          >
            ...
            <span
              className="text-[15px] text-gray-200 font-bold"
              style={{ fontFamily: 'Poppins, sans-serif' }}
            >
              Store 1
            </span>
          ...
          <div className="ml-10 mt-2">
            <div
              className="p-1 mt-1 flex items-center rounded-md px-6 duration-300 cursor-pointer hover:bg-slate-600 text-white"
              onClick={() => {
                toggleStoremenu('/store1/product');
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
              >
                <path d="M4 3h16c.55 0 1 .45 1 1v4H3V4c0-.55.45-1 1-1zm0 6h16v8H4V9zm0 10h16c.55 0 1 .45 1 1v1H3v-1c0-.55.45-1 1-1z" />
              </svg>
              <span
                className="text-[15px] text-gray-200 font-bold"
                style={{ fontFamily: 'Poppins, sans-serif' }}
