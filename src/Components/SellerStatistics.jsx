                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 gap-4 lg:gap-0 mt-5">
                        <a className=" bg-white flex flex-col p-5 border-b-4 lg:border-b-0 lg:border-r-4 border-blue-600">
                            <div className="flex justify-start">
                                <div className="flex items-center justify-center h-10 w-10 bg-blue-200 rounded-full">
                        ...
                        <a className=" bg-white flex flex-col p-5 border-b-4 lg:border-b-0 lg:border-r-4 border-yellow-600">
                            <div className="flex justify-start">
                                <div className="flex items-center justify-center h-10 w-10 bg-yellow-200 rounded-full">
                        ...
                        <a className=" bg-white flex flex-col p-5 border-b-4 lg:border-b-0 lg:border-r-4 border-pink-600">
                            <div className="flex justify-start">
                                <div className="flex items-center justify-center h-10 w-10 bg-pink-200 rounded-full">
                        ...
                        <a className=" bg-white flex flex-col p-5 border-b-4 lg:border-b-0 lg:border-r-4 border-green-600">
                            <div className="flex justify-start">
