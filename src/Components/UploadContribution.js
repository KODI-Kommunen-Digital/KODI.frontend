  ...
  return (
    <div className="bg-blue-400 mx-auto py-10 px-4 flex justify-center lg:h-[28rem] sm:h-[35rem]">
        <div className="flex flex-wrap items-center">
            ...
            <h2 className="text-4xl text-white font-bold mb-4 font-sans">Upload the first post here</h2>
            <p className="mb-4 text-gray-900 text-lg font-bold font-sans">Whether event, offers or news. Here you can easily upload a contribution</p>
            <a
              onClick={() => isLoggedIn ? navigateTo("/OverviewPage") : navigateTo("/")}
              className="ml-0 font-sans inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-blue-800 px-8 py-2 text-base font-semibold text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] cursor-pointer"
            >
              upload post
            </a>
            </div>
