...
function ContactInfo() {
  return (
    <section class="bg-slate-300 body-font relative">
      <div class="container px-5 py-5 mx-auto flex sm:flex-nowrap flex-wrap bg-slate-600">
        <div class="lg:w-4/5 md:w-1/3 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0 p-6 mr-2">
          ...
          <div class="relative mb-4">
            ...
            <input
              ...
              id="email"
              name="email"
              class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" placeholder="Select a time"
            />
          ...
          <div class="relative mb-4">
            ...
            <input
              ...
              id="email"
              name="email"
              class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" placeholder="enter your place"
            />
          </div>
          <div class="relative mb-4">
            <label
